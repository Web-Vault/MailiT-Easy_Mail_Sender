Dear HR,
<br><br>
I am {{$data1['user_name']}}, a final-semester Computer Engineering student at RK University, eager to apply for the PHP/Laravel Developer internship at {{$data1['company_name']}}.
<br><br>
...
<br><br>
Please find the resume attached with the message. I would welcome the chance to discuss how my background aligns with the goals of {{$data1['company_name']}}. Thank you for considering my application.
<br><br>
Warmly,<br>
{{$data1['user_name']}} <br>
+91 8758499499 | <a href="mailto:{{$data1['email']}}"> {{$data1['email']}} </a><br>
LinkedIn | <a href="www.linkedin.com/in/aryan-lathigara-8325062b7"> aryan-lathigara </a><br>